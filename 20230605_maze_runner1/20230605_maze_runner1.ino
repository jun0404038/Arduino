...
void loop()
{
  ...
  if(mission_flag[0]==0)
  {
    ...
    else if((line_index ==0) && (left_sonar <= 100) && (right_sonar <= 100))
    {
      mission_flag[2]=0;
    }
    else
...
void loop1(){
    ...
    target_heading_angle = 310;
    imu_rotation();
    run_heading_angle();
   
    target_heading_angle = 235;
    ...
    target_heading_angle = 238.5;
   
    imu_rotation();
    run_heading_angle();
 
    target_heading_angle = 337;

    imu_rotation();
    run_heading_angle();

    target_heading_angle = 104;

    imu_rotation();
    run_heading_angle();

    target_heading_angle = 18.5;

    imu_rotation();
    run_heading_angle();

    target_heading_angle = 308;

    imu_rotation();
    run_heading_angle();

    target_heading_angle = 8;

    imu_rotation();
    run_heading_angle();

    target_heading_angle = 111;
